    ...
    <div className="container mx-auto px-4 relative z-10">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        className="max-w-xl">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/80 mb-8 leading-relaxed">The only platform that combines powerful construction management software with on-demand expert support.
