    ...
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg leading-relaxed">
          SEDGE Pro assists businesses in the building construction industry to
          build profitable and scalable businesses. Our hybrid platform
          combines powerful project management software with curated,
          on-demand expert support — so you're never alone in making
          critical decisions.
        </p>
      </motion.div>
