...
import { LayoutDashboard, Users, CreditCard, LogOut, BarChart3, Kanban, Package, FileText, Receipt, Building2, Menu, FileEdit, Tag } from "lucide-react";
...
const navItems = [
  ...
  { label: "Site Content", icon: FileEdit, path: "/admin/content" },
